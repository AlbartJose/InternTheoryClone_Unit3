...
async function runProgram() {
    ...
    function apply() {
        ...
        back.href = '/interntheory/internships';
        ...
        function final() {
            ...
            if (sign.signed) {
                window.location.href = '/interntheory/internships/interndetail/fillinfo';
            } else {
                window.open("http://127.0.0.1:2222/interntheory/login");
            }
        }
