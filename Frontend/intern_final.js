...
var internFinal = {
    ...
    skills: {
        ...
        preference = document.getElementsById("preference").value,
        hobbies = document.getElementsById("hobbies").value,
        achievements = document.getElementsById("achievements").value,
    },
    address: {
        address : document.getElementsById("address").value,
        city : document.getElementsById("city").value,
        pincode : document.getElementsById("pincode").value,
        languages : document.getElementsById("languages").value
